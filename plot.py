...
def plot():
    ...
    model_list = ['greedy', 'hierarchical', 'local']
    ...
    for root, dirs, files in os.walk('logs'):
        for dir in dirs:
            ...
            plt.plot(latency_list, label=model_list, save_path=os.path.join('logs', dir, 'task.png'), title='Task completion time')
            plt.plot(power_list, label=model_list, save_path=os.path.join('logs', dir, 'FPSO.png'), title='FPSO condition enhancement')
